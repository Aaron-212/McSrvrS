...
- `xcodebuild -project McSrvrS.xcodeproj -scheme McSrvrS -destination 'platform=iOS Simulator,name=iPhone 16,OS=26.0' build`: build the iOS simulator app, matching CI.
- `xcodebuild -project McSrvrS.xcodeproj -scheme McSrvrS -destination 'platform=macOS' build`: build the macOS app.
- `xcodebuild -project McSrvrS.xcodeproj -scheme McSrvrS -destination 'platform=iOS Simulator,name=iPhone 16,OS=26.0' test`: run tests once a test target is added.
